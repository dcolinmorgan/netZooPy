...
# paste chrb.txt startb.txt A-549b.txt R2island.txt| awk '{print $1,$2,$2+1,$4,$5}' OFS='\t'> A-549_MeArrayb.txt
# paste chrb.txt startb.txt GM12878b.txt R2island.txt| awk '{print $1,$2,$2+1,$4,$5}' OFS='\t'> GM12878_MeArrayb.txt
# paste chrb.txt startb.txt HeLa-S3b.txt R2island.txt| awk '{print $1,$2,$2+1,$4,$5}' OFS='\t'> HeLa-S3_MeArrayb.txt
# paste chrb.txt startb.txt Hep-G2b.txt R2island.txt| awk '{print $1,$2,$2+1,$4,$5}' OFS='\t'> Hep-G2_MeArrayb.txt
# paste chrb.txt startb.txt K562b.txt R2island.txt| awk '{print $1,$2,$2+1,$4,$5}' OFS='\t'> K-562_MeArrayb.txt
# paste chrb.txt startb.txt SKNSHb.txt R2island.txt| awk '{print $1,$2,$2+1,$4,$5}' OFS='\t'> SK-N-SH_MeArrayb.txt

# 
# ##map from 19 to 38 cd to data
# ./data/liftOver MotifPipeline/ENCODE/methyl_array/A-549_MeArrayb.txt hg19ToHg38.over.chain MotifPipeline/ENCODE/methyl_array/A-549_MeArrayHG38b.txt unmapped
# ./data/liftOver MotifPipeline/ENCODE/methyl_array/GM12878_MeArrayb.txt hg19ToHg38.over.chain MotifPipeline/ENCODE/methyl_array/GM12878_MeArrayHG38b.txt unmapped
# ./data/liftOver MotifPipeline/ENCODE/methyl_array/HeLa-S3_MeArrayb.txt hg19ToHg38.over.chain MotifPipeline/ENCODE/methyl_array/HeLa-S3_MeArrayHG38b.txt unmapped
# ./data/liftOver MotifPipeline/ENCODE/methyl_array/Hep-G2_MeArrayb.txt hg19ToHg38.over.chain MotifPipeline/ENCODE/methyl_array/Hep-G2_MeArrayHG38b.txt unmapped
# ./data/liftOver MotifPipeline/ENCODE/methyl_array/K-562_MeArrayb.txt hg19ToHg38.over.chain MotifPipeline/ENCODE/methyl_array/K-562_MeArrayHG38b.txt unmapped
# ./data/liftOver MotifPipeline/ENCODE/methyl_array/SK-N-SH_MeArrayb.txt hg19ToHg38.over.chain MotifPipeline/ENCODE/methyl_array/SK-N-SH_MeArrayHG38b.txt unmapped
# 
